...
void main()
{
	...
	// EXTENSION: same line-of-sight rule as a beam -- see fs_gpubeam.sc's own copy of
	// this block for the reasoning. "GPUOverlay" governs draw order, not whether shroud
	// or fog can hide the anim.
